...
\section*{Résolution du problème avec instance partielle}
\begin{itemize}
\item Pour un cours que l'on a veut rajouter dans un emploi du temps on sélectionne la semaine à partir de laquelle on veut le placer (solution au plus tôt).
\item On trouve un créneau pour la classe sur cette période
\item On regarde si il y a un prof capable d'enseigner cette matière et disponible sur ce même créneau.
\end{itemize}
